<template>
  <!-- <base-frame :border="false"> -->
  <div
    class="has-background-black-ter is-paddingless overflow-hidden is-flex border-radius-6 shadow"
  >
    <div class="columns is-gapless">
      ...
      <div class="column is-6">
        <div class="lead-generator-text">
          <h2 class="title is-3 has-text-white mb-08">
            {{ leadGenerator.title }}
          </h2>
          <p class="mb-28 has-text-white">
            {{ leadGenerator.description }}
          </p>
          <nuxt-link
            :to="leadGenerator.link"
            class="button is-rounded is-light"
            >{{ leadGenerator.action }}</nuxt-link
          >
        </div>
      </div>
    </div>
