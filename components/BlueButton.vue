<template>
  <div class="px-3 inline-flex">
    <nuxt-link
      class="cursor-pointer border-0 hover:bg-blue-600 hover:text-blue-600 active:bg-blue-700 active:text-blue-700 relative bg-blue-500 text-blue-500 inline-flex transition duration-150 ease-in-out focus:outline-none"
      :to="to"
    >
