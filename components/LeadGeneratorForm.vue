  ...
  <div>
    <form class="columns is-multiline" @submit="submitForm" ref="leadGeneratorForm" action="https://ex4d4.dmoe.tech/postforms/tortugawebdesignde-leadgenerator/">
      <div class="column is-6">
        <div class="field">
          ...
          <div class="control has-icons-left">
            <input id="name" class="input" type="text" name="firstname" placeholder="Max / Susi">
      ...
      <div class="column is-6">
        <div class="field">
          ...
          <div class="control has-icons-left">
            <input id="name" class="input" type="text" name="lastname" placeholder="Müller">
            <span class="icon is-small is-left">
      ...
      <div class="column is-6">
        <div class="field">
          ...
          <div class="control has-icons-left">
            <input id="mail" class="input" type="email" name="email" placeholder="mueller@mail.de">
            <span class="icon is-small is-left">
      ...
      <div class="column is-6">
        <div class="field">
          <label class="label" for="message">Dürfen wir Ihnen E-Mails schicken?</label>
          <div class="control">
      ...
      <div class="column is-6">
        <div class="field">
          <div class="control">
            <button class="button is-rounded is-light mt-40">{{ download.action }}</button>
          </div>
        </div>
      </div>
    ...
    <div ref="successMessage" class="message is-success" style="display: none">
      <div class="message-body">
        ...
        <p class=""><a class="" target="_blank" :href="download.link">{{ download.action }}</a></p>
      </div>
    </div>
  </div>
</template>
...
import { faHome, faEnvelope, faUser, faUserFriends } from '@fortawesome/free-solid-svg-icons'
